    ...
    <main class="dashboard-page">
      ...
      <div class="profile-banner">
        ...
        <div class="banner-info">
          <h2>Buhle Mokoena</h2>
          <p><strong>Student Number:</strong> G23M1234</p>
          <p><strong>Residence:</strong> Amina Cachalia</p>
        ...
        <div class="content-grid">
          ...
          <div class="dash-card">
            ...
            <div class="info-row">
              ...
              <span class="val">Buhle Mokoena</span>
            </div>
            <div class="info-row">
              <span class="lbl">Student No.:</span>
              <span class="val">G23M1234</span>
            </div>
            <div class="info-row">
              <span class="lbl">Residence: </span>
              <span class="val">Amina Cachalia</span>
            </div>
          ...
          <div class="dash-card">
            ...
            <div class="stats-row">
              ...
              <div class="stat-item">
                ...
                <span class="stat-val">R450.50</span>
              </div>
            </div>
          </div>
