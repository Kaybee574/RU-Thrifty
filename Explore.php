  ...
  <body>
    ...
    <main>
      ...
      <section class="explore-layout">
        ...
        <!-- This grid which displays the producs -->
        <div class="product-grid">
          ...
          <div class="Categories">
            ...
            <section class="my-category-card">
              <a
                href="category_pictures/Books/48Laws.html"
                class="category-card"
                style="text-decoration: none; color: inherit"
              >
                <img
                  src="category_pictures/Books/Book1.webp"
                  alt="48 Laws of power"
                />
                <p>48 Laws of Power</p>
                <span class="price">R300</span>
                <a href="Stores/Store1/Store1.html" class="Shopitem"
                  ><p class="linkToShop">Gods Angels Books</p></a
                >
              </a>
            </section>
            <!-- item 2 -->
            <section class="my-category-card">
              <a
                ...
                style="text-decoration: none; color: inherit"
              >
                <img src="category_pictures/Books/macB.webp" alt="Macbeth" />
                <p>Macbeth</p>
                <span class="price">R300</span>
                <a href="Stores/Store1/Store1.html" class="Shopitem"
                  ><p class="linkToShop">Gods Angels Books</p></a
            ...
            <section class="my-category-card">
              ...
              >
                <img
                  src="category_pictures/Books/Mock.jpg"
